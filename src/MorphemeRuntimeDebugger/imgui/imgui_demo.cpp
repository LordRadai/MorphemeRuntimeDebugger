...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        ImGui::TextWrapped(
            ...
            "Hover the texture for a zoomed m_view!");
...
static void ShowDemoWindowTables()
{
    ...
    if (open_action != -1)
        ImGui::SetNextItemOpen(open_action != 0);
    IMGUI_DEMO_MARKER("Tables/Tree m_view");
    if (ImGui::TreeNode("Tree m_view"))
    {
    ...
    if (ImGui::TreeNode("Advanced"))
    {
        ...
        if (ImGui::TreeNode("Options"))
        {
            ...
            if (ImGui::TreeNodeEx("Other:", ImGuiTreeNodeFlags_DefaultOpen))
            {
                ...
                // From a user point of m_view we will tend to use 'inner_width' differently depending on whether our table is embedding scrolling.
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        {
            HelpMarker(
                "This is a simplified m_view. See more detailed input state:\n"
...
static void ShowExampleAppLayout(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple layout", p_open, ImGuiWindowFlags_MenuBar))
    {
        ...
        {
            ImGui::BeginGroup();
            ImGui::BeginChild("item m_view", ImVec2(0, -ImGui::GetFrameHeightWithSpacing())); // Leave room for 1 line below us
