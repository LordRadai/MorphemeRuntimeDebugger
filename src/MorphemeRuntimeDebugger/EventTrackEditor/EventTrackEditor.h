...
struct EventTrackEditor
{
    ...
    void AddTrack(int event_id, char* name, bool duration) { return; }
    void DeleteTrack(int idx) { return; }

    void AddEvent(int track_idx, EventTrack::Event event) { return; }
    void DeleteEvent(int track_idx, int event_idx) { return; }
