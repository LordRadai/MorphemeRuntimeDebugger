...
struct ImNodesIO
{
    struct EmulateThreeButtonMouse
    {
        ...
        // The keyboard modifier to use in combination with mouse left click to pan the editor m_view.
    ...
    // Panning speed when dragging an element and mouse is outside the main editor m_view.
